...
<html lang="en">
    ...
    <body onload="<?php echo createAlbumFolder() ?>">
...
admin<p class="friends-bar-last-online">22/04/2019</p>
 ...
 <li class="active"><a href="social-network(view_profile).php"><i class="far fa-user"></i> &nbsp Profile</a></li>
  <li><a href="social-newtwork(manage_my_friends).php"><i class="fas fa-users"></i> &nbsp Friends</a></li>
  <li><a href="social-network(create_new_album).php"><i class="fas fa-images"></i> &nbsp Create Albums</a></li>
 </ul>
...
<div class="db-header clearfix">
    <div class="page-header-title"> <i class="fas fa-images"></i> &nbsp <?php echo getName($_SESSION["username"])."'s albums" ?></div>
...
<div class="the-pictures">
      <?php showGalleryImages();?>      
</div>
<div class="modal-confirm" id="myModal">
                <div class="modal-content">
                    ...
                    <form action="php/home_page_stuff.inc.php" method="POST">
                        <input class="form-control" type="file" name="name" placeholder="Full Name">
                        <hr>
                        <div class="form-wrap stick-to-buttom">
                            <button class="button1" style="color:white">Upload</button>
                        </div>
                    </form>
                </div>
            </div>
