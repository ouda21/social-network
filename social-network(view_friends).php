<?php
  ...
  require "includes/friends_page.inc.php";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li><a href="social-network(home_page).php">Home</a></li>
            ...
            <li class="user_bit"><?php echo "<img src='profile_pictures/".fillProfilePicture1('profile_picture')."' class='user_avatar'>" ?> <a href="javascript:void(0)" class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">              <?php echo $_SESSION["username"] ?>             </a>
...
<?php echo $_SESSION["username"] ?>  </div>
 ...
 <ul>
  <li class="active"><a href="social-network(complete_profile).php"><i class="far fa-user"></i> &nbsp Profile</a></li>
  <li><a href="social-newtwork(manage_my_friends).php"><i class="fas fa-users"></i> &nbsp Friends</a></li>
...
<p><a href="#"><img alt="" src="https://www.patchesoft.com/uploads/titan_blog.png" width="100%" /></a></p>
...
<div class="editor-textarea-part"><textarea name="content" class="editor-textarea" id="editor-textarea" placeholder="What's on your mind <?php echo getName($_SESSION["username"]) ?>..." required></textarea>
  </div>
</div>
</div>
