...
<html lang="en">
    <head>
        ...
        <link href="styles/connect_friends.css" rel="stylesheet">
...
<div class="user-box-avatar">
                ...
                <a href="#"><img src="LadyJustice.jpg" title="admin" data-toggle="tooltip" data-placement="right" /></a>
                </div></div>
...
-->
    ...
    <div id="main-content">
        ...
        <ul>
        <li><a href="#"><i class="fas fa-newspaper"></i> &nbsp Newsfeed</a></li>
        <li><a href="social-network(view_profile).php"><i class="far fa-user"></i> &nbsp Profile</a></li>
        <li><a href="#"><i class="fas fa-inbox"></i> &nbsp Inbox</a></li>
        <li><a href="#"><i class="fas fa-blog"></i> &nbsp Your Blog</a></li>
        <li><a href="social-network(connect_with_friends).php"><i class="fas fa-user-friends"></i> &nbsp Find Friends</a></li>
        <li><a href="#"><i class="fas fa-sliders-h"></i> &nbsp Settings</a></li>
        </ul>
        ...
        <li><a href="#"><i class="far fa-file-alt"></i> &nbsp Pages</a></li>
        <li><a href="#"><i class="fas fa-blog"></i> &nbsp Blogs</a></li>
        <li ><a href="#"><i class="fas fa-suitcase-rolling"></i> &nbsp Saved Posts</a></li>
        <li><a href="#"><i class="fas fa-search-dollar"></i> &nbsp Funds</a></li>
        </ul>
...
<form action="includes/post_status.inc.php" enctype="multipart/form-data" method="POST">
    <!--<input type="hidden" name="csrf_test_name" value="7e97c8399674f181628ded7a106c7988" />
...
<div class="editor-textarea-part"><textarea name="content" class="editor-textarea" id="editor-textarea" placeholder="What's on your mind?" required></textarea>
</div>
</div>
</div>
