...
<html lang="en">
    <head>
        <title>Social Network/view-profile</title>         
        <meta charset="UTF-8" />
      ...
      <div class="container-fluid">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
            ...
            <span class="icon-bar"></span>
                    ...
                    <a class="navbar-brand" href="social-network(home_page).php" title="Social Network">University Social Network(USN)</a>
                </div>
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li><a href="social-network(home_page).php">Home</a></li>
            ...
            <li><a href="social-network(complete_profile).php"> <i class="far fa-user"></i> &nbsp My Profile</a></li>
...
function load_posts(userid) 
{
 ...
 <div class="profile-header" <?php echo "style='background:url(../profile_pictures/".getUserCoverPicture($friend).")'" ?> center center; background-size: cover;">
 <div class="profile-header-avatar">
 <?php echo "<img src='../profile_pictures/".getUserProfilePicture($friend)."'>" ?>
 </div>
 <div class="profile-header-name">
<?php echo getName1($friend) ?>  </div>
 </div>
 <div class="profile-header-bar clearfix">
 <ul>
  <li class="active"><a href="../social-network(complete_profile).php"><i class="far fa-user"></i> &nbsp Message</a></li>
  <li><a href="../social-newtwork(manage_my_friends).php"><i class="fas fa-users"></i> &nbsp Friends</a></li>
...
<?php echo'<p><a href="#"><img alt="" src="universities/".'.getUniversityLogo().' width="100%" /></a></p>' ?>
    ...
    <div class="page-block half-separator">
        <div class="page-block-title">
        <i class="fas fa-users"></i> <a href="social-newtwork(manage_my_friends).php">Friends</a>
        </div>
...
<div class="editor-textarea-part"><textarea name="content" class="editor-textarea" id="editor-textarea" placeholder="Post on <?php echo getName1($friend) ?> profile" required></textarea>
  </div>
</div>
</div>
...
<div class="myposts">
  See <?php getName1($friend)?> posts
</div>
</div>
<div class="myposts-border">
  <?php showMyPosts1($friend) ?>
</div>
...
<div class="modal fade" id="promotePostModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   ...
   <form action="edit_profile.inc.php" method="post" accept-charset="utf-8">
<input type="hidden" name="csrf_test_name" value="1c693a4b799d4252a6fe31d5721917b3" />                                                                                                                   
 <div class="modal fade" id="reportModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><i class="fas fa-flag"></i></span> Report <?php $_SESSION["username"] ?></h4>
      </div>
      <div class="modal-body ui-front form-horizontal">
          <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading">Reason for Reporting</label>
                    <div class="col-md-8">
                        <input type="hidden" value='<?php echo $_SESSION["username"] ?>' name="reporter">
                        <input type="hidden" value='<?php echo $friend ?>' name="reported">
